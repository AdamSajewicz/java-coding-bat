...
public class Logic1 {
    ...
    public boolean nearTen(int num) {
        ...
        return (remaining < 3 || remaining > 7);
    }
    ...
    public boolean twoAsOne(int a, int b, int c) {
        return((a + b - c) == 0 || (a + c - b) == 0 || (c + b - a) == 0);
    }
    ...
    public int sumLimit(int a, int b) {
        ...
        int sumLength = (int) (Math.log10(a + b) + 1);
